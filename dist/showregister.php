                ...
                <div class="card-body">
                    ...
                    <?php
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="editregister.php?ido=<?php echo $data['_id'];?>" class="btn btn-sm btn-warning">Edit</a>
                                <a href="hapusdataregister.php?ido=<?php echo $data['_id'];?>" class="btn btn-sm btn-danger">Hapus</a>
                            </td>
                        </tr>
                        <?php } ?>
                    </table>
