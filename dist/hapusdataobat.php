...
<body>
    <div class="login-container">
        ...
        if (isset($_GET['_id'])) {
            $kb = $collection->findOne(['_id' => new MongoDB\BSON\ObjectID($_GET['_id'])]);
        }
        if (isset($_POST['submit'])) {

            include 'dbconnect.php';
            $collection->deleteOne(['_id' => new MongoDB\BSON\ObjectID($_GET['_id'])]);
            $_SESSION['success'] = "Data Berhasil dihapus";
            header("Location: adminlistobat.php");
        }

        ?>
        <h3> Nama&nbsp;&nbsp;&nbsp;&nbsp;: <?php echo "$kb->nama_obat"; ?></h3>
        <br>
        <form method="POST">
            <div class="form-group">
                <input type="hidden" value="<?php echo "$kb->_id"; ?>" class="form-control" name="_id">
